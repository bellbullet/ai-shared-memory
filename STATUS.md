...
| `AI_DRAWERS.md` | 109 entries / 11 categories / 12 cross-groups; single-file layout retained | Keep caution-marked Web services below the three promoted candidates; consider splitting only when retrieval or maintenance degrades |
