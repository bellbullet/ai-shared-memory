...
| `AI_DRAWERS.md` | 141 entries / 11 categories / 12 cross-groups; single-file layout retained | Evaluate takos / takosumi only after reviewing agent, credential, state, and self-host boundaries; keep road-to-me pending until its repository is available |
