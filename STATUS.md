...
| `AI_DRAWERS.md` | 130 entries / 11 categories / 12 cross-groups; single-file layout retained | Trial book-to-skill only with owned or open-license material; test Amicro components individually in a suitable React UI |
