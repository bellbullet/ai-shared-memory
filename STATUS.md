...
| `AI_DRAWERS.md` | 149 entries / 11 categories / 12 cross-groups; single-file layout retained | Trial img2threejs on an owned or public-safe reference image; inspect generated TypeScript, browser rendering, animation hierarchy, and quality gates |
